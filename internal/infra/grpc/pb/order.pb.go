...
func (x *OrderListResponse) GetOrders() []*CreateOrderResponse {
	if x != nil {
		return x.Orders
	}
	return nil
...
const file_internal_infra_grpc_protofiles_order_proto_rawDesc = "" +
	...
	"\x06orders\x18\x01 \x03(\v2\x17.pb.CreateOrderResponseR\x06orders2\x82\x01\n" +
	"\fOrderService\x12@\n" +
	"\vCreateOrder\x12\x16.pb.CreateOrderRequest\x1a\x17.pb.CreateOrderResponse\"\x00\x120\n" +
	"\n" +
...
var file_internal_infra_grpc_protofiles_order_proto_depIdxs = []int32{
	2, // 0: pb.OrderListResponse.orders:type_name -> pb.CreateOrderResponse
	...
	3, // 4: pb.OrderService.ListOrders:output_type -> pb.OrderListResponse
